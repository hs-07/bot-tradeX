    ...
    <div className="h-full bg-background flex flex-col gap-8 p-4 md:p-16 landing">
      ...
      <div className="flex gap-4 flex-col">
        ...
        <span className="text-white">
          ...
          is collected, used, and disclosed by BotTradeX (collectively, ”
          BotTradeX,” ” we,” ” our” or ” us”). This Policy applies to users
          (“you”) of BotTradeX’ services, websites, applications, and machines
          (each, a ” Service,” and collectively, our ” Services”). <br />
          <br />
      ...
      <div className="flex gap-4 flex-col">
        ...
        <span className="text-white">
          ...
          the data controller of your Personal Information. Remesa Lmited do not
          and will not share, disclose or trade your Personal Information
      ...
      <div className="flex gap-4 flex-col">
        ...
        <span className="text-white">
          BotTradeX takes commercially-reasonable technical, administrative, and
          physical security measures designed to protect your information from
          ...
          To be clear, BotTradeX does not itself store any Personal Information
          of yours or your clients’ through transactions.
          <br />
          <br />
          ...
          information for your BotTradeX account with anyone. If we receive
          instructions using your user name and password, we will consider that
          you have authorised the instructions. If you have reason to believe
          that your interaction with us is no longer secure (e.g., if you feel
          that the security of any account you might have with us has been
          compromised), please contact us immediately as detailed in the Contact
          Us section, below.
        </span>
      </div>
      <div className="flex gap-4 flex-col">
      ...
      <div className="flex gap-4 flex-col">
        ...
        <span className="text-white">
          ...
          from BotTradeX, you may click on the “unsubscribe” link in the email
          to unsubscribe and opt-out of marketing email communications. If you
          have an BotTradeX account, you may also opt-out of marketing emails in
          your account settings. Alternatively, to the extent that applicable
          law requires your prior opt-in consent to receive marketing and
          promotional emails, you can choose not to opt-in. Please note that
          even if you opt-out of receiving marketing communications from one or
          all of our Services, we may need to send you service-related
          communications.
          <br />
          <br />
          Text Messages. If you no longer want to receive text messages from
          BotTradeX, please let us know to opt-out of text messages at
          support@remesa.money or write to us, as detailed in Contact Us
          section. Cookies Choices. To exercise choices regarding cookies set
          through our website, as well as other types of online tracking and
          internet advertising, see our Cookies Policy for more details.
          <br />
          <br />
      ...
      <div className="flex gap-4 flex-col">
        ...
        <span className="text-white">
          ...
          level of protection as your home country. Where required, Remesa
          Limited will ensure that we have adequate safeguards in place so that
          your Personal Information is treated securely and in accordance with
          applicable law and regulation and with our policies and standards. By
          using our Services, and providing us information about you, you
          consent to the international transfer of information about you to the
          above parties. The most common reason for us disclosing information
          overseas is because we use service providers to perform some functions
          on our behalf, and some of these service providers are located outside
          the European Economic Area (EEA). We only disclose information to
          these organisations when it is necessary for the services they provide
          to us. For the most part, these service providers are entities related
          to us which perform a range of technology and operational functions
          for us.
        </span>
      </div>
      <div className="flex gap-4 flex-col">
      ...
      <div className="flex gap-4 flex-col">
        ...
        <span className="text-white">
          ...
          support@remesa.money or by postal mail at:
          <br />
          BotTradeX <br />
