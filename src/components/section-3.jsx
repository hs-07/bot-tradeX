    ...
    <div className="px-20 ">
      <div className="flex flex-col w-full border-x-2 border-borderColor py-20 items-center">
        <div className="font-[600] text-[36px] md:text-[86px] text-white flex flex-col w-full items-center py-12">
          <span className="-mb-10">Comprehensive Services to </span>
          <span className=""> Elevate Your Trading</span>
        </div>
        <p className="text-[30px] text-light-gray leading-[1.2] text-center w-1/2 pb-20">
          Explore our range of services designed to support and enhance your
          trading journey.
        </p>
        <div className="w-full bg-primaryGradient grid grid-cols-3 px-6 h-[70vh] gap-6">
          <div className="text-white w-full flex flex-col items-center gap-6 pt-12">
            <span className="text-center text-[30px] font-[600]">
              {" "}
              BotTradeX_EA_V1 <br /> (XAU/USD)
            </span>
            <p className="text-center text-base text-[20px] pb-12">
