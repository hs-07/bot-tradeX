...
const Section1 = () => {
  return (
    <div className=" min-h-[calc(70dvh-4rem)] md:h-[780px] relative w-full border-y-2 border-borderColor overflow-y-hidden">
      ...
      <div className="z-[9] relative flex flex-col h-[calc(70dvh-4rem)]  md:h-full justify-start items-center pt-48 md:pt-28 gap-[32px] w-full">
