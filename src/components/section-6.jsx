...
const Section6 = () => {
  return (
    <div className="px-4 md:px-20 md:min-h-screen flex flex-col">
      ...
      <div className="border-x border-borderColor pb-20 relative h-[40dvh] md:min-h-screen z-[9] px-8 flex w-full justify-end">
      ...
      <div className="hidden md:flex h-[20vh] w-full bg-background border-x border-borderColor" />
    </div>
  );
};
